...
def read_params():
    p = ap.ArgumentParser(description="",
                          epilog=("The parameters of the selected software generated by this script can be adjusted "
                                  "according to the need of the user and the type of the analysis to be executed "
                                  "by simply open the generated configuration file with a text editor and then "
                                  "add/remove the specific options."),
    ...
    p_db.add_argument('--db_dna', default=None, choices=DB_DNA_CHOICES,
                      help='Add the "db_dna" section of the selected software that will be used for building the '
                           'indexed database')
    p_db.add_argument('--db_aa', default=None, choices=DB_AA_CHOICES,
                      help='Add the "db_aa" section of the selected software that will be used for building the '
                           'indexed database')

    p.add_argument('--map_dna', default=None, choices=MAP_DNA_CHOICES,
                   help='Add the "map_dna" section of the selected software that will be used for mapping '
                        'the database against the input genomes')
    p.add_argument('--map_aa', default=None, choices=MAP_AA_CHOICES,
                   help='Add the "map_aa" section of the selected software that will be used for mapping '
                        'the database against the input proteomes')
    ...
    p.add_argument('--trim', default=None, choices=TRIM_CHOICES,
                   help='Add the "trim" section of the selected software that will be used for the gappy '
                        'regions removal of the MSAs')
    p.add_argument('--gene_tree1', default=None, choices=GENE_TREE1_CHOICES,
                   help='Add the "gene_tree1" section of the selected software that will be used for building '
                        'the phylogenies for the markers in the database')
    ...
    p.add_argument('--tree1', required=True, default=None, choices=TREE1_CHOICES,
                   help='Add the "tree1" section of the selected software that will be used for building the '
                        'first phylogeny')
