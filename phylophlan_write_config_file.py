...
def read_params():
    p = ap.ArgumentParser(description="",
                          epilog=("The parameters of the selected software generated by this script can be adjusted according to the "
                                  "need of the user and the type of the analysis to be executed by simply open the generated "
                                  "configuration file with a text editor and then add/remove the specific options."),
